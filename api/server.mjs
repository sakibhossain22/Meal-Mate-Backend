    ...
    auth = betterAuth({
      ...
      socialProviders: {
        google: {
          ...
          redirectURI: `${process.env.BETTER_AUTH_URL}/dashboard`
        }
      }
    });
  }
...
var init_order_routes = __esm({
  "modules/order/order.routes.ts"() {
    ...
    router2.patch("/provider/update-order/:id", auth_default("PROVIDER" /* PROVIDER */, "CUSTOMER" /* CUSTOMER */), orderController.updateOrder);
...
var init_admin_routes = __esm({
  "modules/admin/admin.routes.ts"() {
    ...
    router3.get("/all-categories", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */), adminController.Allcategories);
    router3.get("/all-users", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */), adminController.getAllUsers);
    router3.get("/all-orders", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */, "DELIVERY" /* DELIVERY */), adminController.getAllOrders);
    router3.post("/add-category", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */), adminController.addCategory);
    router3.patch("/update-user/:id", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */), adminController.updateUserStatus);
    router3.delete("/delete-reviews/:id", auth_default("ADMIN" /* ADMIN */, "SUPERADMIN" /* SUPERADMIN */), adminController.deleteReview);
    adminRouter = router3;
  }
});
...
var providerStats, getAllProvider, createProvider, providerDetails, getAllProviderMeal, providerServices;
...
var providerStats2, getAllProvider2, providerDetails2, createProvider2, getAllProviderMeal2, providerController;
var init_provider_controller = __esm({
  "modules/providers/provider.controller.ts"() {
    ...
    createProvider2 = async (req, res) => {
      const { id } = req.params;
      try {
        const data = await providerServices.createProvider(req.body);
        res.status(200).json({
          success: true,
          ok: true,
          data
    ...
    getAllProviderMeal2 = async (req, res) => {
      console.log(req.user);
      try {
        const data = await providerServices.getAllProviderMeal(req.user);
        res.status(200).json({
          success: true,
          ok: true,
          data
    ...
    providerController = {
      ...
      getAllProviderMeal: getAllProviderMeal2
    };
  }
});
...
var init_provider_routes = __esm({
  "modules/providers/provider.routes.ts"() {
    ...
    router5.get("/allprovidermeal", auth_default("PROVIDER" /* PROVIDER */), providerController.getAllProviderMeal);
    router5.get("/:id", providerController.providerDetails);
    router5.post("/create", providerController.createProvider);
    providerRouter = router5;
  }
});

// modules/userProfile/userProfile.services.ts
var userProfile, allUserProfile, updateUserProfile, userProfileService;
...
var userProfile2, allUserProfile2, updateUserProfile2, userProfileController;
var init_userProfile_controller = __esm({
  "modules/userProfile/userProfile.controller.ts"() {
    ...
    allUserProfile2 = async (req, res) => {
      try {
        const data = await userProfileService.allUserProfile(req.user);
        res.status(200).json({
          success: true,
          ok: true,
          data
    ...
    userProfileController = {
      ...
      allUserProfile: allUserProfile2
    };
  }
});
...
var init_userProfile_routes = __esm({
  "modules/userProfile/userProfile.routes.ts"() {
    ...
    router6.get("/", auth_default("ADMIN" /* ADMIN */, "CUSTOMER" /* CUSTOMER */, "PROVIDER" /* PROVIDER */, "DELIVERY" /* DELIVERY */, "SUPERADMIN" /* SUPERADMIN */), userProfileController.userProfile);
    router6.get("/user", auth_default("ADMIN" /* ADMIN */, "CUSTOMER" /* CUSTOMER */, "PROVIDER" /* PROVIDER */, "DELIVERY" /* DELIVERY */, "SUPERADMIN" /* SUPERADMIN */), userProfileController.allUserProfile);
    router6.patch("/update", auth_default("ADMIN" /* ADMIN */, "CUSTOMER" /* CUSTOMER */, "PROVIDER" /* PROVIDER */, "DELIVERY" /* DELIVERY */, "SUPERADMIN" /* SUPERADMIN */), userProfileController.updateUserProfile);
...
// modules/delivery/delivery.services.ts
var createDelivery, acceptOrderService, updateDeliveryStatusService, toggleAvailabilityService, getDeliveryStatsService, getDeliveryHistoryService, getMyOrdersService, deliveryServices;
var init_delivery_services = __esm({
  "modules/delivery/delivery.services.ts"() {
    "use strict";
    init_enums();
    init_AppError();
    init_prisma();
    createDelivery = async (bodyData) => {
    ...
    acceptOrderService = async (orderId, deliveryManId) => {
    ...
    updateDeliveryStatusService = async (orderId, status) => {
      if (!orderId || !status) {
    ...
    toggleAvailabilityService = async (userId, isAvailable) => {
      if (!userId || isAvailable === void 0) {
    ...
    getDeliveryStatsService = async (deliveryManId) => {
      if (!deliveryManId) {
      ...
      const [overallStats, monthlyStats, recentOrders] = await Promise.all([
        ...
        prisma.order.groupBy({
          ...
          where: {
            deliveryManId,
            status: OrderStatus.DELIVERED,
            updatedAt: { gte: new Date(Date.now() - 7 * 24 * 60 * 60 * 1e3) }
          },
          _count: { id: true },
          _sum: { totalPrice: true }
        })
      ...
      return {
        ...
        chartData,
        // লাস্ট ৭ দিনের পারফরম্যান্স
        success: true
      };
    };
    getDeliveryHistoryService = async (deliveryManId) => {
      if (!deliveryManId) {
        throw new AppError("Missing required field: deliveryManId", 400);
      }
    ...
    getMyOrdersService = async (deliveryManId) => {
      if (!deliveryManId) {
        throw new AppError("Missing required field: deliveryManId", 400);
      }
      return await prisma.order.findMany({
...
var createDelivery2, acceptOrderService2, updateDeliveryStatusService2, toggleAvailabilityService2, getDeliveryStatsService2, getMyOrdersService2, getDeliveryHistoryService2, deliveryController;
var init_delivery_controller = __esm({
  "modules/delivery/delivery.controller.ts"() {
    "use strict";
    init_delivery_services();
    createDelivery2 = async (req, res) => {
      try {
        const data = await deliveryServices.createDelivery(req.body);
        res.status(200).json({
          success: true,
          ok: true,
          data
    ...
    acceptOrderService2 = async (req, res) => {
      try {
    ...
    updateDeliveryStatusService2 = async (req, res) => {
      try {
    ...
    toggleAvailabilityService2 = async (req, res) => {
      try {
    ...
    getDeliveryStatsService2 = async (req, res) => {
      try {
        const userId = req?.user?.id;
    ...
    getMyOrdersService2 = async (req, res) => {
      try {
        const userId = req?.user?.id;
    ...
    getDeliveryHistoryService2 = async (req, res) => {
      try {
        const userId = req?.user?.id;
    ...
    deliveryController = {
      ...
      acceptOrderService: acceptOrderService2,
      updateDeliveryStatusService: updateDeliveryStatusService2,
      toggleAvailabilityService: toggleAvailabilityService2,
      getDeliveryStatsService: getDeliveryStatsService2,
      getDeliveryHistoryService: getDeliveryHistoryService2,
      getMyOrdersService: getMyOrdersService2
    };
  }
});

// modules/delivery/delivery.routes.ts
import express8 from "express";
var router8, deliveryRouter;
var init_delivery_routes = __esm({
  "modules/delivery/delivery.routes.ts"() {
    "use strict";
    init_delivery_controller();
    init_auth2();
    router8 = express8.Router();
    router8.post("/create", deliveryController.createDelivery);
    router8.get("/my-orders", auth_default("DELIVERY" /* DELIVERY */), deliveryController.getMyOrdersService);
    router8.patch("/accept-order", auth_default("DELIVERY" /* DELIVERY */), deliveryController.acceptOrderService);
    router8.patch("/update-status/", auth_default("DELIVERY" /* DELIVERY */), deliveryController.updateDeliveryStatusService);
    router8.patch("/toggle-availability", auth_default("DELIVERY" /* DELIVERY */), deliveryController.toggleAvailabilityService);
    router8.get("/stats", auth_default("DELIVERY" /* DELIVERY */), deliveryController.getDeliveryStatsService);
    router8.get("/history", auth_default("DELIVERY" /* DELIVERY */), deliveryController.getDeliveryHistoryService);
    deliveryRouter = router8;
  }
});

// modules/superadmin/superAdmin.services.ts
var manageUser, getSystemStats, verifyProvider, verifyDeliveryMan, createCategory, getAllOrders3, getAllProvidersProfile, getAllDeliveryMenProfiles, superAdminServices;
var init_superAdmin_services = __esm({
  "modules/superadmin/superAdmin.services.ts"() {
    "use strict";
    init_enums();
    init_AppError();
    init_prisma();
    manageUser = async (userId, role, status) => {
    ...
    verifyProvider = async (providerId, isVerified) => {
    ...
    verifyDeliveryMan = async (deliveryManId, isVerified) => {
      if (typeof isVerified !== "boolean") {
        throw new AppError("Invalid verification status", 400);
      }
      if (!deliveryManId) {
    ...
    getAllDeliveryMenProfiles = async () => {
...
var manageUser2, getSystemStats2, verifyProvider2, getAllDeliveryMenProfiles2, getAllProvidersProfile2, verifyDeliveryMan2, createCategory2, getAllOrders4, superAdminController;
var init_superAdmin_controller = __esm({
  "modules/superadmin/superAdmin.controller.ts"() {
    "use strict";
    init_superAdmin_services();
    manageUser2 = async (req, res) => {
      try {
    ...
    getAllDeliveryMenProfiles2 = async (req, res) => {
      try {
    ...
    getAllProvidersProfile2 = async (req, res) => {
      try {
    ...
    verifyDeliveryMan2 = async (req, res) => {
      try {
    ...
    superAdminController = {
      ...
      verifyProvider: verifyProvider2,
      createCategory: createCategory2,
      getAllOrders: getAllOrders4,
      verifyDeliveryMan: verifyDeliveryMan2,
      getAllDeliveryMenProfiles: getAllDeliveryMenProfiles2,
      getAllProvidersProfile: getAllProvidersProfile2
    };
  }
});

// modules/superadmin/superAdmin.routes.ts
import express9 from "express";
var router9, superAdminRouter;
var init_superAdmin_routes = __esm({
  "modules/superadmin/superAdmin.routes.ts"() {
    "use strict";
    init_superAdmin_controller();
    init_auth2();
    router9 = express9.Router();
    router9.patch("/manage-user", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.manageUser);
    router9.get("/system-stats", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.getSystemStats);
    router9.patch("/verify-provider", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.verifyProvider);
    router9.patch("/verify-delivery", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.verifyDeliveryMan);
    router9.post("/categories", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.createCategory);
    router9.get("/all-orders", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.getAllOrders);
    router9.get("/delivery-men-profiles", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.getAllDeliveryMenProfiles);
    router9.get("/providers-profiles", auth_default("SUPERADMIN" /* SUPERADMIN */), superAdminController.getAllProvidersProfile);
    superAdminRouter = router9;
  }
});

// modules/ai/ai.service.ts
var generateAIResponse;
  ...
  "modules/ai/ai.service.ts"() {
    ...
    generateAIResponse = async (message) => {
      ...
      const mealDataString = meals.map((meal) => {
        const categoryName = Array.isArray(meal.category) ? meal.category.map((cat) => cat.name).join(", ") : meal.category?.name || "General";
...
var router10, aiRoutes;
var init_ai_route = __esm({
  "modules/ai/ai.route.ts"() {
    "use strict";
    init_ai_controller();
    router10 = Router();
    router10.post("/chat", chatWithAI);
    aiRoutes = router10;
  }
});
